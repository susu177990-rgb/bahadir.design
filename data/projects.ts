    ...
    groups: [
      {
        ...
        preview: {
          ...
          items: [
            { src: "/video/01-01.mp4", alt: "AI Video 案例片段 01" },
            { src: "/video/01-02.mp4", alt: "AI Video 案例片段 02" },
            { src: "/video/01-03.mp4", alt: "AI Video 案例片段 03" },
            { src: "/video/01-04.mp4", alt: "AI Video 案例片段 04" },
            { src: "/video/01-05.mp4", alt: "AI Video 案例片段 05" },
            { src: "/video/01-06.mp4", alt: "AI Video 案例片段 06" },
